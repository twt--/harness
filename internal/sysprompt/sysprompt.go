...
// listing available agent skills for progressive disclosure. ModePrompt carries
// the active run mode's instructions and is appended as the final section, so a
// mode layers on top of every other customization.
type Options struct {
