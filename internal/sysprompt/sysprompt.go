...
// listing available agent skills for progressive disclosure. AgentPrompt carries
// the active agent's instructions and is appended as the final section, so an
// agent definition layers on top of every other customization.
type Options struct {
